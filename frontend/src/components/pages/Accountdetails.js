...
export default function Accountdetails(props) {
    ...
    useEffect(async () => {
        ...
        let transactions_table = createTransactionsTable(data_transactions);
    ...
    function createTransactionsTable(data) {
        ...
        for (let i = data.length - 1; i >= 0; i--) {
            if (data[i].sender_id == props.match.params.address || data[i].receiver_id == props.match.params.address) {
